...
// |v|^2
static f32 v2_len_squared(v2 v) {
    return v2_dot(v, v);
}
static f32 v3_len_squared(v3 v) {
    return v3_dot(v, v);
}

// |v|
static f32 v2_len(v2 v) {
    return f_sqrt(v2_len_squared(v));
}
static f32 v3_len(v3 v) {
    return f_sqrt(v3_len_squared(v));
}

// Normalize a vector
// returns 0 for a zero vector
static v2 v2_normalize(v2 v) {
    return v * f_inv_sqrt(v2_len_squared(v));
}
static v3 v3_normalize(v3 v) {
    return v * f_inv_sqrt(v3_len_squared(v));
}

// Rotate vector by 90* (Counter Clockwise)
static v2 v2_rot90(v2 v) {
    return (v2){-v.y, v.x};
};
