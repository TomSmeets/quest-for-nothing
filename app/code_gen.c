...
void *main_init(int argc, char *argv[]) {
    ...
    handle_dir(&f, &m, "tlib");
    handle_dir(&f, &m, "app");
    handle_dir(&f, &m, "quest_for_nothing");
    handle_dir(&f, &m, "ledger");

    c_encode(&f, "GL_SHADER_VERT", os_read_file(&m, "tlib/gl_shader.vert"));
    c_encode(&f, "GL_SHADER_FRAG", os_read_file(&m, "tlib/gl_shader.frag"));
