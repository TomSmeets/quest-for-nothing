...
static void handle_file(mem *m, char *path) {
    ...
    while(tok) {
        ...
        if(new_statement && tok_is_symbol(tok, "enum")) {
            ...
            char *name = tok->str;
            os_printf("static const char * const enum_to_str_%s[] = {\n", name);
...
void *main_init(int argc, char *argv[]) {
    ...
    os_printf("// Copyright (c) 2023 - Tom Smeets <tom@tsmeets.nl>\n");
    os_printf("// generated.h - This file is generated by " __FILE__ "\n");
