...
static void sdl_api_load(sdl_api *api) {
    void *lib = os_dlopen("libSDL2.so");
    if(!lib) lib = os_dlopen("SDL2.dll");
    assert(lib);
    api->SDL_Init                 = os_dlsym(lib, "SDL_Init");
    api->SDL_Quit                 = os_dlsym(lib, "SDL_Quit");
    api->SDL_PollEvent            = os_dlsym(lib, "SDL_PollEvent");
    api->SDL_CreateWindow         = os_dlsym(lib, "SDL_CreateWindow");
    api->SDL_GetWindowSize        = os_dlsym(lib, "SDL_GetWindowSize");
    api->SDL_GL_SetSwapInterval   = os_dlsym(lib, "SDL_GL_SetSwapInterval");
    api->SDL_GL_SetAttribute      = os_dlsym(lib, "SDL_GL_SetAttribute");
    api->SDL_GL_SwapWindow        = os_dlsym(lib, "SDL_GL_SwapWindow");
    api->SDL_GL_CreateContext     = os_dlsym(lib, "SDL_GL_CreateContext");
    api->SDL_GL_GetProcAddress    = os_dlsym(lib, "SDL_GL_GetProcAddress");
    api->SDL_GetWindowDisplayMode = os_dlsym(lib, "SDL_GetWindowDisplayMode");
    api->SDL_SetRelativeMouseMode = os_dlsym(lib, "SDL_SetRelativeMouseMode");
    api->SDL_OpenAudio            = os_dlsym(lib, "SDL_OpenAudio");
    api->SDL_PauseAudio           = os_dlsym(lib, "SDL_PauseAudio");
    api->SDL_LockAudio            = os_dlsym(lib, "SDL_LockAudio");
    api->SDL_UnlockAudio          = os_dlsym(lib, "SDL_UnlockAudio");
    api->SDL_SetWindowFullscreen  = os_dlsym(lib, "SDL_SetWindowFullscreen");
    api->SDL_SetHint              = os_dlsym(lib, "SDL_SetHint");
}
